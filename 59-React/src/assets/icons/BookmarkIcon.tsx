...
export const BookmarkIcon: FC<BookmarkIconProps> = ({ stroke = 'currentColor', width = 24, height = 24, className }) => (
	<svg width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
		<path
			...
			strokeWidth="2"
		/>
		<path d="M15 6H9" stroke={stroke} strokeWidth="2" strokeLinecap="round" />
	</svg>
);
